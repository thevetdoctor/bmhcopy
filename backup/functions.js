...
var update = function (password) { return __awaiter(void 0, void 0, void 0, function () {
    var passwordUpdate;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                passwordUpdate = function (password) { return __awaiter(void 0, void 0, void 0, function () {
                    var response;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, firebase_1.auth
                ...
                return [4 /*yield*/, firebase_1.auth
                        ...
                        if (authUser) {
                            ...
                            console.log('user is signed in as > ', authUser === null || authUser === void 0 ? void 0 : authUser.email);
